...
// DefaultStunServers is a built-in list of public STUN servers used as a
// fallback when no controller-provided reflection endpoint is available.
//
// Callers should randomly sample a few of these, query each with per-endpoint
// fault tolerance (a public server may be down), and take the majority-consistent
// mapping. The list is intentionally large so that random sampling has a high
// chance of hitting several live servers.
